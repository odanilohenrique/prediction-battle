        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex items-center justify-between mb-8">
                ...
                <button
                    ...
                    className="flex items-center gap-2 bg-yellow-500/10 hover:bg-yellow-500/20 text-yellow-500 font-medium px-4 py-3 rounded-xl transition-all border border-yellow-500/30"
                >
                    ⚡ Force Cron
                </button>
